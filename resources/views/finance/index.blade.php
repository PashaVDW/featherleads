        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-7.5">
          ...
          <div class="card">
            <div class="card-body lg:pt-9 lg:pb-7.5">
              <div class="flex justify-center mb-2.5">
                <div
                  class="flex items-center justify-center relative text-2.5xl text-info size-20 ring-1 ring-info-clarity bg-info-light rounded-full"
                >
                  S
                  <div
                    class="flex size-2.5 bg-success rounded-full absolute bottom-0.5 left-16 transform -translate-y-1/2"
          ...
          <div class="card p-7.5">
            <div class="flex items-center flex-wrap justify-between gap-5">
              <div class="flex items-center gap-3.5">
                <div class="flex justify-center">
                  <div
                    class="flex items-center justify-center relative text-2.5xl text-danger size-20 ring-1 ring-danger-clarity bg-danger-light rounded-full"
                  >
                    K
                    <div
                      class="flex size-2.5 bg-success rounded-full absolute bottom-0.5 left-16 transform -translate-y-1/2"
          ...
          <div class="card p-7.5">
            <div class="flex items-center flex-wrap justify-between gap-5">
              <div class="flex items-center gap-3.5">
                <div class="flex justify-center">
                  <div
                    class="flex items-center justify-center relative text-2.5xl text-success size-20 ring-1 ring-success-clarity bg-success-light rounded-full"
                  >
                    M
                    <div
                      class="flex size-2.5 bg-gray-400 rounded-full absolute bottom-0.5 left-16 transform -translate-y-1/2"
                    ></div>
                  </div>
                </div>
                <div class="grid">
