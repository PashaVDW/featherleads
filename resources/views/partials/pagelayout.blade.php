<div class="flex grow">
  ...
  <div class="wrapper flex grow flex-col">
    <header
      class="header fixed top-0 z-10 left-0 right-0 flex items-stretch shrink-0 bg-[#fefefe] dark:bg-coal-500"
      data-sticky="true"
      ...
      >
        ...
        <div class="flex items-center gap-2 lg:gap-3.5">
          ...
          >
            ...
            <div
              class="dropdown-content light:border-gray-300 w-full max-w-[450px]"
            >
              <div class="">
                <div
                ...
                <div class="shadow-card border-b border-gray-200 py-2.5">
                  <div
                    class="flex items-center justify-between flex-wrap gap-2 px-5"
                  >
              ...
              <div class="mb-2.5">
                <div
                  class="flex grow gap-2 p-5 bg-gray-100 mb-2.5"
                  id="join_request"
                >
                  <div class="relative shrink-0">
                    <img
                ...
                <div class="relative grow mx-5">
                  ...
                  />
                  <input
                    class="input h-auto py-4 ps-12 bg-transparent"
          ...
          >
            ...
            <div
              class="dropdown-content light:border-gray-300 w-full max-w-[320px]"
            >
              <div
              ...
              <div
                class="flex flex-col scrollable-y-auto max-h-[400px] divide-y divide-gray-200"
              >
                <div
                  class="flex items-center justify-between flex-wrap gap-2 px-5 py-3.5"
                >
                  <div class="flex items-center flex-wrap gap-2">
                    <div
                  ...
                  >
                    <div class="flex flex-col gap-5 pt-3 pb-4">
                      ...
                      <div class="flex items-center grow gap-2.5 px-5">
                        ...
                        >
                          <i
                            class="ki-filled ki-check text-lg text-success"
                          ></i>
                        </div>
                        <div class="flex flex-col gap-1">
                          ...
                          <div class="flex items-center gap-2.5">
                            ...
                            >
                              <div
                                ...
                                style="
                                  background-image: url('/static/metronic-tailwind-html/dist/assets/media/images/600x600/6.jpg');
                                "
                              ></div>
                            ...
                            >
                              <div
                                class="bg-cover bg-no-repeat card-rounded-t shrink-0 h-24"
                                style="
                                  background-image: url('/static/metronic-tailwind-html/dist/assets/media/images/600x600/1.jpg');
                                "
                              ></div>
                              <div class="px-2.5 pb-2">
                                <a
          ...
          <div class="menu" data-menu="true">
            ...
            >
              <div class="menu-toggle btn btn-icon rounded-full">
                <img
                  alt=""
                  class="size-9 rounded-full border-2 border-success shrink-0"
                  src="assets/media/avatars/300-2.png"
                />
              </div>
              <div
                class="menu-dropdown menu-default light:border-gray-300 w-full max-w-[250px]"
              >
                <div
